        ...
        try {
          ...
          if (response.data.length > 0) {
            setNuevoConcepto({
              ...
              concepto: response.data[0].concepto,
              precio: response.data[0].precio,
              cantidad: 1 // Default value or fetch from API
            });
          }

          const cotizacionResponse = await axios.get(`/api/cotizaciones/cotizaciones?cotizacion_id=${cotizacion}`);
          setRecibo(cotizacionResponse.data[0].cotizacion)
